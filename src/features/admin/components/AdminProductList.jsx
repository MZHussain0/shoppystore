          ...
          {products.map((product) => (
            <div key={product.id}>
              <Link to={`/details/${product.id}`}>
                <div className="group relative bg-gray-100 border-solid border-2 p-2 border-gray-200 rounded-lg ">
                  ...
                  {product.stock < 1 && (
                    <p className="mt-1 text-sm text-rose-500">OUT OF STOCK</p>
                  )}
                </div>
              </Link>
              <div className="mt-4">
                <Link
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white w-full py-2 px-4  rounded-md">
                  Edit Product
                </Link>
              </div>
            </div>
